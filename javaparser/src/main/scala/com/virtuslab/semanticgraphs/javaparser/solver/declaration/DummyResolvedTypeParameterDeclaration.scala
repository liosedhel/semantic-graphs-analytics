...
import com.virtuslab.semanticgraphs.javaparser.solver.declaration.{ DummyResolvedTypeDeclaration, DummyResolvedTypeParametrizable }
import com.virtuslab.semanticgraphs.javaparser.solver.TypeArgumentsResolutionCache

import com.github.javaparser.resolution.declarations.{ ResolvedReferenceTypeDeclaration, ResolvedTypeParameterDeclaration, ResolvedTypeParametrizable }
